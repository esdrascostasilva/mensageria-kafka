...
namespace tuvigaDev
{
	...
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"Curso\",\"namespace\":\"tuvigaDev\",\"fields\":[{\"name\":\"Id\",\"t" +
				"ype\":\"string\"},{\"name\":\"Descricao\",\"type\":\"string\"}]}");
		private string _Id;
